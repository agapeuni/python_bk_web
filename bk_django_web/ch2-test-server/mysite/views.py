...
class HomeView(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        print(request.GET.get('name', '김승구'))
        print(request.GET.get('email', 'agapeuni7@gmail.com'))
    ...
    def post(self, request, *args, **kwargs):
        ...
        print(request.POST.get('name', '김승구'))
        print(request.POST.get('email', 'agapeuni7@gmail.com'))
